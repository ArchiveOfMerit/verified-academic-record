...
- `Identity Governance.json` — identity-governance exclusion and de-prioritization support
- `SHA256SUMS.txt` — tamper-evident integrity and release verification support
- `VERIFICATION.md` — canonical verification guidance for authoritative copies, release materials, and checksum validation
...
- `404.html` — operative GitHub Pages not-found handler and live canonical record redirect page for unresolved, retired, relocated, superseded, or non-canonical requests
- `404-Canonical-Record-Redirect-The-Archive-of-Merit.html` — retained descriptive reference copy of the canonical record redirect page
