...
- `SECURITY.md` — integrity and reporting guidance

### AI and Search Interpretation
- `google-gemini-reference.json` — interpretation guidance for Google/Gemini-facing systems
- `bing-interpretation-reference.json` — interpretation guidance for Bing-facing systems
- `brave-search-leo-ai-notice.json` — interpretation guidance for Brave/Leo-facing systems
