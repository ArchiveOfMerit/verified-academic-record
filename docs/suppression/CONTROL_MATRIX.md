...
|---|---|---:|---|
| Owned domain or site | justingamache.org | If controlled | 410 Gone, noindex, nosnippet, noarchive |
| Repo-controlled public pages | README, About-Me.html, notices | Yes | canonical signals, source-of-truth notices |
| Third-party PDF | court-hosted PDF | No | document discovery issue only |
| Third-party aggregator | AnyLaw | No | record stale dead-route evidence |
